...
namespace Barberia.Negocio
{
    public class Cls_Rule_Personal
    {
        ...
        public T_M_PERSONAL ListarUno_Personal(int id, ref Cls_Ent_Auditoria auditoria)
        {
            T_M_PERSONAL lista = new T_M_PERSONAL();
            try
            {
                lista = ObjPersonal.ListarUno_Cargo(id, ref auditoria);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public bool Eliminar_Personal(T_M_PERSONAL entidad, ref Cls_Ent_Auditoria auditoria)
        {
            ...
            try
            {
                exito = ObjPersonal.Eliminar_Personal(entidad, ref auditoria);
            }
            catch (Exception ex)
            {
                throw ex;
