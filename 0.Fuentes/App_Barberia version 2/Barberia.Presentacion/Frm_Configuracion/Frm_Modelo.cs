...
namespace Barberia.Presentacion.Frm_Configuracion
{
    ...
    {
        private Cls_Rule_Modelo ObjModelo = new Cls_Rule_Modelo();
        string user; //usuario logeado
        public Frm_Modelo(string usuario)
        {
            InitializeComponent();
            user = usuario;
        }
        ...
        private void Limpiar()
        {
            ...
            dataGridView1.DataSource = ObjModelo.Listar_Modelo(1,ref auditoria);
        ...
        private void Frm_Modelo_Load(object sender, EventArgs e)
        {
            ...
            dataGridView1.Columns["DES_MODELO"].HeaderText = "MODELO";
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(txtDescripcion.Text))
            {
                ...
                Cls_Ent_Auditoria auditoria = new Cls_Ent_Auditoria();
                entidad.DES_MODELO = txtDescripcion.Text.Trim().ToUpper();
                entidad.FLG_ESTADO = "1";
                entidad.USU_CREACION = user;
                entidad.FEC_CREACION = DateTime.Now;
                exito = ObjModelo.Insertar_Modelo(entidad, ref auditoria);
                if (exito)
                {
                    Limpiar();
        ...
        private void btnActualizar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                T_M_MODELO entidad = new T_M_MODELO();
                Cls_Ent_Auditoria auditoria = new Cls_Ent_Auditoria();
                entidad.ID_MODELO = int.Parse(lblIdModelo.Text);
                entidad.DES_MODELO = txtDescripcion.Text.Trim().ToUpper();
                ...
                exito = ObjModelo.Actualizar_Modelo(entidad, ref auditoria);
                if (exito)
                {
                    Limpiar();
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    bool exito = ObjModelo.Eliminar_Modelo(entidad, ref auditoria);
                    if (exito)
                    {
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            Cls_Ent_Auditoria auditoria = new Cls_Ent_Auditoria();
            entidad.DES_MODELO = txtDescripcion.Text.Trim().ToUpper();
            dataGridView1.DataSource = ObjModelo.Buscar_Modelo(entidad, ref auditoria);
        }
        ...
        private void dataGridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            {
                lblIdModelo.Text = dataGridView1.CurrentRow.Cells["ID_MODELO"].Value.ToString();
                txtDescripcion.Text = dataGridView1.CurrentRow.Cells["DES_MODELO"].Value.ToString();
